...
interface ButtonProps extends Omit<
  ...
  'onAnimationStart' | 'onDragStart' | 'onDragEnd' | 'onDrag' | 'onSubmit'
> {
  children: ReactNode;
...
export default function Button({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-gray-800 text-white hover:bg-gray-900 focus:ring-gray-800 shadow-md hover:shadow-lg',
  ...
  const appliedSizeStyles = (variant === 'icon' || hasCustomPadding) ? '' : sizeStyles[size];
